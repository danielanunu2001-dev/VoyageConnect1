...
public class RsaKeyGenerator {
    ...
    private void generateAndSaveKeys() throws Exception {
        ...
        try (java.io.FileOutputStream fos = new java.io.FileOutputStream(PUBLIC_KEY_FILE)) {
        ...
        try (java.io.FileOutputStream fos = new java.io.FileOutputStream(PRIVATE_KEY_FILE)) {
            fos.write(iv);
